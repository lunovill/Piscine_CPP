...
int	main(void) {
	...
	Animal *rex = new Dog();
	std::cout << ansi((short[]){BOLD}, 1) + std::string(23, '-') << "TRUE" << ansi((short[]){BOLD}, 1) + std::string(23, '-') << std::endl;
	...
	Animal *rex = new Dog();
	std::cout << ansi((short[]){BOLD}, 1) + std::string(22, '-') << "FALSE" << ansi((short[]){BOLD}, 1) + std::string(23, '-') << std::endl;
