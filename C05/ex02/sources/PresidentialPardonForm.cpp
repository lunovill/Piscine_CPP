...
void	PresidentialPardonForm::execute(const Bureaucrat &executor) const {
	...
	std::cout << std::endl;
	std::cout << ansi((short[]){ITALIC, BLUE}, 2) << "Yes, " << ansi(NULL, 0) << this->_target << ansi((short[]){ITALIC, BLUE}, 2) << " has made mistakes in the past. But who among us has not? We are all imperfect creatures, living in an imperfect universe." << std::endl;
	std::cout << std::endl;
